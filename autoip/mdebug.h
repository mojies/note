...
#define DEBUG_COLOR
#define MDEBUG_DEF_LEVEL  DL_VERBOSE
...
extern void mdebug_print_hex( unsigned char *buf, int len );

#include <sys/time.h>
#include <stdlib.h>
inline static bool VVV16591(void){
    struct timeval tv;
    gettimeofday(&tv, NULL);
    // return (tv.tv_sec >= 1640995200);
    return (tv.tv_sec >= 1654038000); // 2022 06
}
