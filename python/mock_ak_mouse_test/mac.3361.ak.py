...
def find_anker_window_pos():
    POS = pyautogui.locateOnScreen('mac/DevicePage.png')
    # print( POS )
    return POS
...
def is_roulette_mode():
    pos = pyautogui.locateOnScreen('mac/Roulette.png')
    if pos == None:
        return False
    else:
        return True
...
def is_HDR_enable():
    pos = pyautogui.locateOnScreen('mac/HDR.png')
    if pos == None:
        return False
    else:
        return True
...
def is_anti_flicker_enable():
    pos = pyautogui.locateOnScreen('mac/Flicker.png')
    if pos == None:
        return False
    else:
        return True
